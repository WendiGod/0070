...
struct igtlpolydata_
{
  ...
  _points_type points;
   ...
   typedef std::vector< ::geometry_msgs::Point32_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::geometry_msgs::Point32_<ContainerAllocator> >> _polygons_type;
  _polygons_type polygons;

   typedef std::vector< ::ros_igtl_bridge::vector_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::ros_igtl_bridge::vector_<ContainerAllocator> >> _strips_type;
  _strips_type strips;

   typedef std::vector< ::ros_igtl_bridge::vector_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::ros_igtl_bridge::vector_<ContainerAllocator> >> _lines_type;
  _lines_type lines;

   typedef std::vector< ::ros_igtl_bridge::vector_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::ros_igtl_bridge::vector_<ContainerAllocator> >> _verts_type;
  _verts_type verts;
